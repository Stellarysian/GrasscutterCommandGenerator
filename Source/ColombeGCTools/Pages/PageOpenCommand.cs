...
using ColombeGCTools.DispatchServer;
using ColombeGCTools.DispatchServer.Model;
using ColombeGCTools.Game;
using ColombeGCTools.GOOD;
using ColombeGCTools.OpenCommand;
...
namespace ColombeGCTools.Pages
{
    internal partial class PageOpenCommand : BasePage
    {
        ...
        {
            UIUtil.OpenURL("https://github.com/Stellarysian/gc-opencommand-plugin");
        }
